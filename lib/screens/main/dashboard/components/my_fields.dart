import 'package:app_dashboard_responsivo/models/MyFiles.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // *********** CARDS PRICIPAL UTILIZANDO GridView
        Responsive(
...
class FileInfoCardGridView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      physics:
          NeverScrollableScrollPhysics(), // Desabilitar o scroll da GridView
      shrinkWrap: true,
